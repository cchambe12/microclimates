...
%EMWFeb2022: Check my 20% is okay! (from EMWDec31: My 20% is a quick and dirty estimate from Table S6: intercept of 438, site of 41, method of 1.5 site x method of 43.5 ... so 86/438)
...
%EMWFeb2022: I suggest we Bonhomme right after 'Understanding the complexity of the apparently simple GDD model' (above)
%EMWFeb2022: Also, half this paragraph did not print to pdf ... so check it does before submitting. 
...
%EMWFeb2022: Be consistent HOBO or hobo?
