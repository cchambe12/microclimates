...
% EMW10Feb -- small tweaks below (incl. merged paragraphs that I may have divided, see what you think -- could go either way). I also changed 'due to smaller chilling effects through warmer winters' some as we don't know what chilling is so should not use 'due to,' IMHO. 
...
% EMW10Feb -- Amazing work! This reads *way* better (no pun intended). Nice!
