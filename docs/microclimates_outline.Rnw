...
\begin{figure}
  \begin{subfigure}{.5\linewidth}
    ...
    \caption{}
    \centering
    \includegraphics[height=4cm, width=8cm]{..//analyses/figures/muplot_urban_real.pdf}
...
\begin{figure}
  \begin{subfigure}{\linewidth}
    ...
    \caption{}
    \centering
    \includegraphics[height=4cm, width=16cm]{..//analyses/figures/gddratio_basetemps.pdf}
  ...
  \begin{subfigure}{\linewidth}
	    ...
	    \caption{}
      \centering
      \includegraphics[height=6cm, width=7cm]{..//analyses/figures/gddaccuracy_basetemps.pdf}
      \label{fig:slopes}
  \end{subfigure}
