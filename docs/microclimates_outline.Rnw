...
\begin{figure}[H]
  \begin{subfigure}{.32\textwidth}
    ...
    \caption{}
    \centering
    \includegraphics[height=5cm, width=6cm]{..//analyses/figures/muplot_noisyws.pdf}
  ...
  \end{subfigure}%
    \begin{subfigure}{.32\textwidth}
      ...
      \caption{}
      \centering
      \includegraphics[height=5cm, width=6cm]{..//analyses/figures/muplot_noisyhobo.pdf}
  ...
  \begin{subfigure}{.32\textwidth}
	    ...
	    \caption{}
      \centering
      \includegraphics[height=5cm, width=6cm]{..//analyses/figures/muplot_micros.pdf}
...
\begin{figure}[H]
  \begin{subfigure}{.32\textwidth}
    ...
    \caption{}
    \centering
    \includegraphics[height=3cm, width=6cm]{..//analyses/figures/gdd_methods_noisyws.pdf}
  ...
  \begin{subfigure}{.32\textwidth}
      ...
      \caption{}
      \centering
      \includegraphics[height=3cm, width=6cm]{..//analyses/figures/gdd_methods_noisyhobo.pdf}
  ...
  \begin{subfigure}{.32\textwidth}
	    ...
	    \caption{}
      \centering
      \includegraphics[height=3cm, width=6cm]{..//analyses/figures/gdd_methods_micros.pdf}
      \label{fig:gddmicros}
      \end{subfigure}
...
\begin{figure}
  \begin{subfigure}{\linewidth}
    ...
    \caption{}
    \centering
    \includegraphics[height=5cm, width=16cm]{..//analyses/figures/forecasting.pdf}
  ...
  \begin{subfigure}{\linewidth}
	    ...
	    \caption{}
      \centering
      \includegraphics[height=7cm, width=8cm]{..//analyses/figures/forecasting_slopes.pdf}
      \label{fig:slopes}
  \end{subfigure}
