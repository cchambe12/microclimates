...
\item We chose two sites---one urban arboretum and one forest---with overlapping species and climates to compare the number of growing degree days to leafout across species. 
  ...
  \item The Arnold Arboretum is 281 acres and has a range of elevation of XX to XXm.
...
{\begin{figure} [H]
  -\begin{center}
  -\includegraphics[width=12cm]{..//analyses/figures/sims/hypoth_noisyws_20.pdf}
  -\caption{}\label{fig:simsnoisyws}
  -\end{center}
  -\end{figure}}
