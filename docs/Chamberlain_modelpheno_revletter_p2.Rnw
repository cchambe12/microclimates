...
% EMW10Feb -- I updated the text here in the main text. If you keep the changes be sure to update the quoted text here. 
\begin{quotation} 
...
\textit{L116-117: mention/reference Denny et al. (2014) as methods/protocols used to collect phenology observations at Arnold Arb, since you give method info for John O'Keefe's methods (L127)? \url{https://doi.org/10.1007/s00484-014-0789-5}} \\
