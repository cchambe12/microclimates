...
mod_station_dvr <- brm(gdd_dvr ~ spp, data=station,
                      control=list(max_treedepth = 15,adapt_delta = 0.99),
                      iter=4000, warmup=2500)

save(mod_station_dvr, file="stan/mod_station_dvr.Rdata")

mod_hobo_dvr <- brm(gdd_dvr_hobo ~ spp, data=hobo,
                   control=list(max_treedepth = 15,adapt_delta = 0.99),
                   iter=4000, warmup=2500)

save(mod_hobo_dvr, file="stan/mod_hobo_dvr.Rdata")
