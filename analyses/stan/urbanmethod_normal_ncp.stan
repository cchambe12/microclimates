...
transformed parameters {
  ...
  vector[N] yhat;
   ...
   b_method = mu_b_method_sp + sigma_b_method_sp*b_method_ncp; ///NEED to define the sigma_b_method_sp
...
model {
	...
	//b_tx ~ normal(mu_b_tx_sp, sigma_b_tx_sp);  
	      b_tx_ncp ~ normal(0,75);
	      b_method_ncp ~ normal(0,150);
	      
        mu_a_sp ~ normal(500, 100);
